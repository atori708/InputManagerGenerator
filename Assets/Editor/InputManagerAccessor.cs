...
public class InputSettingData : ICloneable
{
	...
	public static InputSettingData CreateKeyAxis(string name, string negativeButton, string positiveButton, string altNegativeButton, string altPositiveButton)
	{
		var axis = new InputSettingData(name);
		axis.name = name;
